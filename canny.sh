...
g++ imread_canny.cpp canny.cpp sobel.cpp `pkg-config --cflags --libs ~/installation/OpenCV-3.4.4/lib64/pkgconfig/opencv.pc` -O3 -pg -o imread_canny.o -fopenmp -fno-tree-vectorize -march=native -fopt-info-vec
